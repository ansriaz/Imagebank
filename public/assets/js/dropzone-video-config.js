...
Dropzone.options.myDropzone = {
    ...
    dictFileTooBig: 'Video is bigger than 20MB',
    ...
    init: function() {
        ...
        this.element.querySelector("button[type=submit]").addEventListener("click", function(e) {
            ...
            if($("#classlabels").val() == "" && $("#selClasses :selected").text() == "")
            {
                alert("Kindly select class from the list or write new name for dataset.");
            }
            if($("#classlabels").val() == "" && $("#selClasses :selected").text() == "Select Class")
            {
                alert("Kindly select class from the list or write new name for dataset.");
            }
